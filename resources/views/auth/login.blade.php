        ...
        <div class="mx-auto" style="width: 600px;">
            <div class="signin-wrapper" style="background-color: transparent;">
                <div class="form-wrapper" style="margin:auto;">
                    ...
                    <h6 class="mb-15" style="display: block; font: 900 3em Lato; text-align:center;">
                        {{ __('ANNYEONGHASEYO!') }}</h6>
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-6 col-lg-12 col-md-6"
                                style="width: 400px; display: flex; margin-left: auto; margin-right: auto; display: flex;justify-content:space-between;">
                                <div class="form-check checkbox-style mb-30">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}"
                                            style="text-decoration: underline; text-align: right; padding-left: 45px;">{{ __('Forgot Your Password?') }}</a>
                                    @endif
                                </div>
                            ...
                            <div class="col-12"
                                ...
                                <div class="switch-login" style="text-align: center; padding: 15px;">
                                    New customer? <a href="/register" class="or-login"
                                        style="color: #cc2e3a; text-decoration:underline; ">Sign up here</a>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
