           ...
           <div class="container ">
               <div class="row justify-content-center ">
                   <div class="col-xs-10 col-md-8">
                       ...
                       <span class="fw-normal">Your order request has been placed. Proceed to pay your order no.
                           {{ $payment->trackingnumber }} in my orders.</span>
                   </div>
                   ...
                   <div class="col-lg-10 mt-4" style="background-color: #EDEDED; padding: 2.75rem 5rem;">
                       ...
                       <table class="table table-bordered">
                           ...
                           <tbody class="fw-normal">
                               ...
                               @endforeach
                               <tr>
                                   <th scope="row" colspan="4" class="text-end pb-0 pe-2"> Shipping
                                       Fee</th>
                                   <td class="pb-0 ">₱100.00</td>
                               </tr>
                               <tr>
                                   <th scope="row" colspan="4" class="text-end pe-2"> <span class="fw-bold">Order
                                           Total</span></th>
