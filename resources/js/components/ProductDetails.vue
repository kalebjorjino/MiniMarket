<style lang="scss">
    .main-box{
        ...
        .btn-yellow:hover, .save-canvas:disabled{
        ...
        .customize{
            ...
            .product-details{
                ...
                .details-box{
                    ...
                    .qty-btn-plus, .qty-btn-minus, .qty-text{
                    ...
                    .qty-btn-minus{ border-radius: 3px 0px 0px 3px; }
                    .qty-btn-plus{ border-radius: 0px 3px 3px 0px; }

                    .qty-btn-minus:before{ background: #fff;}
                    .qty-btn-plus:before{ background: #fff;}
                }
                ...
                .selected{
                    ...
                    box-shadow: 0rem 0rem .5rem rgba($color: #DDAB54, $alpha: .15);
                }
            }
        }
...
<template>
    <div class="main-box">
        ...
        <div class="customize">
            <div>
                <img ref="box" :style="{'max-width' : 450+'px'}" :src="imageUrl" alt="">
            ...
            <div class="product-details">
                <div class="details-box">
                    ...
                    <div class="fw-normal mb-2" v-html="product.description"> </div>


                    <div class="d-flex  align-items-center">
                        <!-- <h6 style="margin-right: 1.5rem; margin-bottom: 0px;"> Price: </h6> -->
                        <h3 class="my-2 fw-bold"> &#8369;&nbsp; {{ parseFloat(price).toFixed(2)}}</h3>
                        <!-- <h5 style="margin-bottom: 0px;"> &#8369;&nbsp; {{maglathala == 'Colored' ? parseInt(product.print_price)*this.qty + parseInt(price): parseInt(price)}}</h5> -->
                    </div>

                    <div class="d-flex  align-items-center">
                        <span style="margin-right: 1.5rem; font-size: 0.85rem;"> Stocks: {{ stocks }}</span>
                    </div>

                    <h6 class="mt-4 fw-normal">Quantity</h6>
                    <div class="d-flex">
                        <button @click="changeQty(-1)" class="btn qty-btn-minus"><i class="fa-solid fa-minus"></i></button>
                        <input class="qty-text" type="text" min="1" v-model="qty" @change="changeQty(0)">
                        <button @click="changeQty(1)" class="btn qty-btn-plus"><i class="fa-solid fa-plus"></i></button>
                        
                        <button :disabled="isLoading" class="view-btn ms-3" @click="addToCart()" > Add to Cart  <i v-if="isLoading" class="fa-solid fa-circle-notch fa-spin ml-2"></i> </button>
                    </div>
        ...
        methods: {
            ...
            async addToCart(){
                ...
                if(errors.length > 0){
                    ...
                    await axios.post("/addtocart", formdata)
                    .then( function (res){
            ...
            checkQty(){ 
                if(this.qty == '' || this.qty < 0 || !(/^\d*\.?\d*$/.test(this.qty))) this.qty = 1
            ...
            changeSlide(val){
                ...
                if( this.slide > Math.ceil(this.samples.length/3)) this.slide += -1
            },
